...
def test_conditional_process_submission_then_branch() -> None:
    ...
    then_rule = ExactMatchQuestionRule(question_id="q2", answer="yes", max_points=3.0)
    else_rule = ExactMatchQuestionRule(question_id="q2", answer="no", max_points=1.0)
...
def test_conditional_missing_question_raises() -> None:
    ...
    then_rule = ExactMatchQuestionRule(question_id="q2", answer="yes")
...
def test_or_aggregation_with_multiple_if_rules() -> None:
    ...
    then_rule = ExactMatchQuestionRule(question_id="q3", answer="ok", max_points=2.0)
...
def test_multiple_then_rules_return_multiple_results() -> None:
    ...
    then1 = ExactMatchQuestionRule(question_id="q2", answer="a", max_points=1.0)
    then2 = ExactMatchQuestionRule(question_id="q3", answer="b", max_points=1.5)
...
def test_else_rules_empty_returns_empty_list_when_condition_false() -> None:
    ...
    then_dummy = ExactMatchQuestionRule(question_id="q_dummy", answer="x")
